...
<spring:url var="rpath" value="/resources/manager" />
  <%
  List<sys_Applications> list=(List<sys_Applications>)request.getAttribute("list"); 
  %>
  <!-- 头部菜单 Start -->
	        <table border='0' cellpadding='0' cellspacing='0' width='100%' align='center'>
              ...
              <tr>
                ...
                <td class='menubar_menu_td' align='right'><table border="0" cellspacing="0" cellpadding="0"><tr><td class="menubar_button" id="button_0" OnClick="JavaScript:window.location.href='Manager?CMD=New';" OnMouseOut="javascript:MenuOnMouseOver(this);" OnMouseOver="javascript:MenuOnMouseOut(this);"><img border="0" align="texttop" src="${rpath}/images/ICON/new.gif">&nbsp;新增应用</td><td class="menubar_button" id="button_1" OnClick="JavaScript:window.location.href='Orderby.aspx';" OnMouseOut="javascript:MenuOnMouseOver(this);" OnMouseOver="javascript:MenuOnMouseOut(this);"><img border="0" align="texttop" src="${rpath}/images/ICON/orderby.gif">&nbsp;排序应用</td></tr></table></td>
              </tr>
	        ...
	        <TABLE height=22 cellSpacing=0 cellPadding=0 border=0>
		        <TBODY>
                       <TR>
				         ...
				         <TD class=tab id=tabLabel__0 onclick='javascript:tabClick(0,1)' background='${rpath}/images/Menu/tab_unactive_bg.gif' UNSELECTABLE='on'>应用列表</TD>
...
<table class="table-box" cellspacing="1" border="0" id="ctl00_PageBody_GridView1" style="background-color:White;border-width:0px;">
		...
		<%
  Iterator<sys_Applications> it=list.iterator();  
 sys_Applications app=null;
...
<div id="ctl00_PageBody_Pager"></div>

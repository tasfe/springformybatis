...
<div class="liuyan">
     <p> 
      ...
      <form:textarea path="gbContent" rows="5" cols="50" cssClass="zily"/>
    <span class="required">* 必填</span>
    <form:errors path="gbContent" cssClass="error" />      
      </span>
      </p>
 </div> 
<div class="tjiao"><p>    <input name="" type="submit" value="提交" class="tijiao" /> <input name="" type="reset" value="重置" /></p></div>

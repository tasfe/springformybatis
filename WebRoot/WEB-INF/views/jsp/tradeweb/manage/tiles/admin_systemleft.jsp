              ...
              <tr> 
                ...
                <table width="90%" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="84%" height="20"><div align="left"><font color="#FFFF00"><%="系统管理"%></font></div></td>
                    </tr>
                  </table>
                  <%
   ...
   while(it.hasNext())
   {
      ...
      <table width="90%" height="28" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="66%" valign="bottom"><div align="left"><a href="/<%=username%>/manage/<%=submenuoper.getSubmenuoperLink()%>"><font color="#FFFF00"><%=submenuoper.getSubmenuoperName()%></font></a></div></td>
                    </tr>
                  </table>
      ...
      <%   
                   ...
                   <table width="90%" height="28" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="34%" height="20" align="right"><img src="/resources/admin/images/Left_1_1.gif" width="29" height="16"></td>
                      <td width="66%" valign="bottom"><div align="left"><a href="/<%=username%>/" target="_blank"><font color="#FFFF00"><%="前台预览"%></font></a></div></td>
                    </tr>
                  </table>
				  <p>&nbsp;</p></td>
              </tr>

...
biz_menuoper menuoper=(biz_menuoper)request.getAttribute("menuoper");
 %>
 <br/><br/>
<form:form modelAttribute="webmenu">
<table border="0" cellspacing="1" cellpadding="0" class="table" style="width:100%;" align="left">
<tr class="tr">
    <td colspan="2" class="td">编辑<%=menuoper.getMenuoperName()%>
    </td>    
  </tr>    
  
  <tr class="tr">
    <td class="td" colspan="2"><form:textarea path="menuContent"/>
    <span class="required">* 必填</span>
    <form:errors path="menuContent" cssClass="error" />
                        </td>
  </tr>    
...
<script type="text/javascript">//<![CDATA[
var editor=CKEDITOR.replace('menuContent');
//,{toolbar : 'Basic'  }

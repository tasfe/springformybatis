...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table">
  <tr class="tr">    
    <td class="td"><a href="?cmd=new">添加公司介绍</a></td>    
  </tr>
  </table>  
  <%
  ...
  <tr class="tr">
    ...
    <td><%=news.getCmmName()%></td>    
    <td><a href="?cmd=edit&id=<%=news.getCommoninfoid()%>">编辑</a>||<a href="?cmd=del&id=<%=news.getCommoninfoid()%>" onclick="javascript:return p_del()">删除</a></td>    
  </tr>   
  <%
  }  
  %>

...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            width=9></td>
                                                    <td width="100" align="center" valign="baseline" background="/resources/admin/images/tab_b2.gif">自由首页</td>
                                              ...
                                              <td height="397" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr> 
                                                  <td align="center"> <table width="98%" border="0" cellspacing="0" cellpadding="0">
                                                      <tr> 
                                                        <td><fieldset>
                                                          <legend><strong>自由首页(FreeContent)</strong></legend>
                                                          ...
                                                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                           ...
                                                           <form:form modelAttribute="website">
                                                                  <table width="100%" border="0" cellpadding="1" cellspacing="1" align="center">
                                                                   <tr valign="middle"> 
                                                                      <td align="left"> 
                                                                        内容标题： <form:input path="wFree"/>
                                                                        </td>
                                                                    </tr>
                                                                    <tr valign="middle"> 
                                                                      <td align="left"> 
                                                                        <form:textarea path="wFreetext"/>
                                                                        </td>
                                                                    </tr>
                                                                    <tr height="25"> 
...
<script type="text/javascript">//<![CDATA[
var editor=CKEDITOR.replace('wFreetext');
//,{toolbar : 'Basic'  }

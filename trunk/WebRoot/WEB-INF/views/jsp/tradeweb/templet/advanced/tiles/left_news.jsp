...
<div class="gycpfl-bottom">
 ...
 List<web_newsclass> list=(List<web_newsclass>)request.getAttribute("list_newsclass");
  ...
  seq++;
    ...
    %>
    <li> <img src="/resources/template/company/images/jqlb_12.jpg" width="14" height="11" />&nbsp;<a href="/${username}/news/${menu.menuid}/<%=menu.getNewsclassid()%>"><%=menu.getNcName()%></a></li>
    <%
    }

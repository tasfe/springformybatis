...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table">
  <tr class="tr">    
    <td class="td"><a href="?cmd=new">添加新闻</a></td>    
  </tr>
  </table>  
  <%
  ...
  <tr class="tr">
    ...
    <td><%=news.getNewsclass().getNcName()%></td>
    <td><%=news.getNewsSource()%></td>
    <td><%=news.getNewsHits()%></td>
    <td><%=updatetime%></td>
    <td><a href="?cmd=edit&id=<%=news.getNewsid()%>">编辑</a>||<a href="?cmd=del&id=<%=news.getNewsid()%>" onclick="javascript:return p_del()">删除</a></td>    
  </tr>   
  <%
  }  
  %>

...
<!-- 头部菜单 Start -->
	        <table border='0' cellpadding='0' cellspacing='0' width='100%' align='center'>
              ...
              <tr>
                <td height='27px' class='menubar_function_text'>目前操作功能：编辑供求</td>
                <td class='menubar_menu_td' align='right'><table border="0" cellspacing="0" cellpadding="0"><tr><td class="menubar_button" id="button_0" OnClick="JavaScript:window.location.href='List';" OnMouseOut="javascript:MenuOnMouseOver(this);" OnMouseOver="javascript:MenuOnMouseOut(this);"><img border="0" align="texttop" src="${rpath}/images/ICON/list.gif">&nbsp;列表供求</td></tr></table></td>
              </tr>
    ...
    <!-- 选项卡 Start -->
        ...
        <form:form modelAttribute="supplyinfo" enctype="multipart/form-data" onSubmit="return Validate();">        
    <table width="100%" border="0" cellspacing="1" cellpadding="3" align="center">
  
  <tr>
    <td width="18%" class="table_body">供求标题</td>
    <td width="82%" class="table_none">
    <form:input path="supplyinfoTitle" cssStyle="width:200px;" /><span class="required">* 必填</span>
                       <form:errors path="supplyinfoTitle" cssClass="error" /></td>
  </tr>
  <tr>
    <td class="table_body">自定义属性</td>
    <td class="table_none"><form:checkboxes path="supplyinfoFlag" items="${sortlist}"/>
                       <form:errors path="supplyinfoFlag" cssClass="error" /> </td>
  </tr>
  <tr>
    <td class="table_body">供求类别</td>
    <td class="table_none">
    ...
    <form:option value="">请选择类别</form:option>
                    ...
                    <form:errors path="supplyinfoSc" cssClass="error" /></td>
  </tr>
  <tr>
    <td class="table_body">供求类型</td>
    <td class="table_none"><form:select path="supplyinfoType" cssStyle="width:100px;">
                    <form:option value="">请选择类别</form:option>
  ...
  <tr>
    ...
    <form:input path="fileData" type="file"/>    
                       <form:errors path="fileData" cssClass="error" /> 
                        ...
                        <c:if test="${! empty supplyinfo.supplyinfoThumbs}">
                        <img src="${supplyinfo.supplyinfoThumbs}" width="100" height="60" />
                        </c:if>                                          
                        </td>
                    </tr>
                    </table></td>
  ...
  <tr>
    ...
    <td class="table_none" colspan="2"><form:textarea path="supplyinfoDes"/>
    <span class="required">* 必填</span>
    <form:errors path="supplyinfoDes" cssClass="error" /></td>
  </tr> 

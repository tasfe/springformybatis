...
<!-- 头部菜单 Start -->
	        <table border='0' cellpadding='0' cellspacing='0' width='100%' align='center'>
              ...
              <tr>
                <td height='27px' class='menubar_function_text'>目前操作功能：产品信息列表</td>
	        ...
	        <TABLE height=22 cellSpacing=0 cellPadding=0 border=0>
		        <TBODY>
                       <TR>
				         ...
				         <TD class=tab id=tabLabel__0 onclick='javascript:tabClick(0,1)' background='${rpath}/images/Menu/tab_unactive_bg.gif' UNSELECTABLE='on'>产品列表</TD>
...
<%
  ...
  <table class="table-box" cellspacing="1" border="0" id="ctl00_PageBody_GridView1" style="background-color:White;border-width:0px;">
		<tr class="table_title" align="center">
			<th scope="col">序号</th><th scope="col">产品名称</th><th scope="col">所属企业</th><th scope="col">类别</th><th scope="col">市场价格</th><th scope="col">优惠价格</th><th scope="col">更新时间</th><th scope="col">操作</th>
		</tr>
  <%
Iterator<web_product> it=list.iterator();  
  ...
  <tr class="<%=seq%2==1?"row":"row1"%>" align="center" style="height:28px;">
			...
			<td><%=updatetime%></td>
			<td><a href="?cmd=edit&id=<%=product.getProductid()%>">编辑</a>||<a href="JavaScript:DelData('?cmd=del&id=<%=product.getProductid()%>')">删除</a></td>
		</tr>

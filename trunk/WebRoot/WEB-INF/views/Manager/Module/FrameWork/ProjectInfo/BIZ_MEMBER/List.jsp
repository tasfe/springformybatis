...
<!-- 头部菜单 Start -->
	        <table border='0' cellpadding='0' cellspacing='0' width='100%' align='center'>
              ...
              <tr>
                <td height='27px' class='menubar_function_text'>目前操作功能：会员列表</td>
                <td class='menubar_menu_td' align='right'><table border="0" cellspacing="0" cellpadding="0"><tr><td class="menubar_button" id="button_0" OnClick="JavaScript:window.location.href='?cmd=new';" OnMouseOut="javascript:MenuOnMouseOver(this);" OnMouseOver="javascript:MenuOnMouseOut(this);"><img border="0" align="texttop" src="${rpath}/images/ICON/new.gif">&nbsp;新增会员</td></tr></table></td>
              </tr>
	        ...
	        <TABLE height=22 cellSpacing=0 cellPadding=0 border=0>
		        <TBODY>
                       <TR>
				         ...
				         <TD class=tab id=tabLabel__0 onclick='javascript:tabClick(0,1)' background='${rpath}/images/Menu/tab_unactive_bg.gif' UNSELECTABLE='on'>用户列表</TD>
...
<%
  ...
  <table class="table-box" cellspacing="1" border="0" id="ctl00_PageBody_GridView1" style="background-color:White;border-width:0px;">
		<tr class="table_title" align="center">
			<th scope="col">序号</th><th scope="col">用户名</th><th scope="col">真实姓名</th><th scope="col">联系电话</th><th scope="col">企业名称</th><th scope="col">是否锁定</th><th scope="col">注册时间</th><th scope="col">操作</th>
		</tr>
  <%
  Iterator<biz_member> it=list.iterator();  
  biz_member member=null;
  String[] strArray={"<font color=\"#CC9900\">锁定</font>","<font color=\"#FF0000\">解锁</font>"}; 
  ...
  <tr class="<%=seq%2==1?"row":"row1"%>" align="center" style="height:28px;">
			...
			<td><%=member.getMemberRealname()%></td>
			<td><%=member.getMemberTel()%></td>
			<td><%=member.getWebsite().getwComname()%></td>					
			<td><%=strArray[(int)member.getMemberLock()]%></td>
			<td><%=df.format(member.getMemberRegdate())%></td>
			<td><a href="?cmd=edit&id=<%=member.getMemberid()%>">编辑</a>||<a href="JavaScript:DelData('?cmd=del&id=<%=member.getMemberid()%>')">删除</a></td>
		</tr>

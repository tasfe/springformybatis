...
<!-- 头部菜单 Start -->
	        <table border='0' cellpadding='0' cellspacing='0' width='100%' align='center'>
              <tr>
                <td class='menubar_title'><img border='0' src='${rpath}/images/ICON/applist.gif' align='absmiddle' hspace='3' vspace='3'>&nbsp;模板列表管理</td>
                <td class='menubar_readme_text' valign='bottom'><img src='${rpath}/images/ICON/office.gif' align='absMiddle' border='0' />&nbsp;帮助？</td>
              </tr>
              <tr>
                <td height='27px' class='menubar_function_text'>目前操作功能：模板列表</td>
                <td class='menubar_menu_td' align='right'><table border="0" cellspacing="0" cellpadding="0"><tr><td class="menubar_button" id="button_0" OnClick="JavaScript:window.location.href='?cmd=new';" OnMouseOut="javascript:MenuOnMouseOver(this);" OnMouseOver="javascript:MenuOnMouseOut(this);"><img border="0" align="texttop" src="${rpath}/images/ICON/new.gif">&nbsp;新增模板</td></tr></table></td>
              </tr>
	        ...
	        <TABLE height=22 cellSpacing=0 cellPadding=0 border=0>
		        <TBODY>
                       <TR>
				         ...
				         <TD class=tab id=tabLabel__0 onclick='javascript:tabClick(0,1)' background='${rpath}/images/Menu/tab_unactive_bg.gif' UNSELECTABLE='on'>模板列表</TD>
        ...
        <DIV id='tabContent__0'>
            ...
            <div>
            <%
    List<biz_templet> list=(List<biz_templet>)request.getAttribute("templetlist");
  ...
  <table class="table-box" cellspacing="1" border="0" id="ctl00_PageBody_GridView1" style="background-color:White;border-width:0px;">
		<tr class="table_title" align="center">
			<th scope="col">序号</th><th scope="col">模板名称</th><th scope="col">模板类型</th><th scope="col">模板代号</th><th scope="col">模板介绍</th><th scope="col">操作</th>
		</tr>
  <%
  Iterator<biz_templet> it=list.iterator();  
  biz_templet member=null;
  ...
  <tr class="<%=seq%2==1?"row":"row1"%>" align="center" style="height:28px;">
			...
			<td><%=member.getTempletName()%></td>
			<td><%=member.getTempletclass().getTcName()%></td>			
			<td><%=member.getTempletCode()%></td>
			<td><%=member.getTempletIntro()%></td>
			<td><a href="?cmd=edit&id=<%=member.getTempletid()%>">编辑</a>||<a href="JavaScript:DelData('?cmd=del&id=<%=member.getTempletid()%>')">删除</a></td>
		</tr>

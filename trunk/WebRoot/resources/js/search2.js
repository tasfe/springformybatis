	...
	function addFavorite()
	{
        ...
        {  
             value = document.getElementById("114chnkey").value;
              ...
              if(value=="请输入您要找的企事业单位、店名、地址等查询关键词" || value=="请输入您要找的产品信息查询关键词" || value=="请输入您要找的供求信息查询关键词" || value=="请输入您要找的分类信息查询关键词")
              {  
            ...
            if(value.length>=2)
            {
                newUrl="/searchresult?type="+searchtype+"&key="+encodeURI(value.toLowerCase().replace("script","").replace("}",""));                
        ...
        function SetSearchType(stype)
        {
           ...
           if(searchtype==1)
           {
             document.getElementById("114chnkey").value="请输入您要找的企事业单位、店名、地址等查询关键词";
           }
           if(searchtype==2)
           {
             document.getElementById("114chnkey").value="请输入您要找的产品信息查询关键词";
           }
           if(searchtype==3)
           {
             document.getElementById("114chnkey").value="请输入您要找的供求信息查询关键词";
           }
           if(searchtype==4)
           {
...
function  AutoTxt()
{
  ...
  if(keyvalue=="请输入您要找的企事业单位、店名、地址等查询关键词" || keyvalue=="请输入您要找的产品信息查询关键词" || keyvalue=="请输入您要找的供求信息查询关键词" || keyvalue=="请输入您要找的分类信息查询关键词")
  {  
    document.getElementById("114chnkey").value="";	
  }
